...
class CovidNet_DE(nn.Module):
    def __init__(self, n_classes=3):
        super(CovidNet_DE, self).__init__()
        filters = {
            'pexp1_1': [64, 256],
            'pexp1_2': [256, 256],
            'pexp1_3': [256, 256],
        ...
        self.add_module('Dropout1',nn.Dropout(0.3))
        self.add_module('Dropout2',nn.Dropout(0.3))
    ...
    def forward(self, x):
        ...
        conv_module = pepx41 + pepx42 + pepx43 + out_conv4_1x1
        conv_module = conv_module.view(-1,7 * 7 * 2048)

        fc1out = F.relu(self.fc1(conv_module))
